...
addpath('./src')
inputDir = '';
Recon_filename_part1 = [inputDir '../3_Final_reconstruction_volume/anneal_30min_GST_volume_part1.mat'];
Recon_filename_part2 = [inputDir '../3_Final_reconstruction_volume/anneal_30min_GST_volume_part2.mat'];
% load reconstructed 3D volume
Dsetvol_part1 = importdata(Recon_filename_part1);
Dsetvol_part2 = importdata(Recon_filename_part2);
Dsetvol = cat(3,Dsetvol_part1,Dsetvol_part2);
%%
...
ourputstring = [inputDir './Output/Atom_tracing_all_peaks_anneal_30min_GST'];
