...
addpath('./src')
inputDir = '';
Recon_filename_part1 = [inputDir '../3_Final_reconstruction_volume/as_dep_GST_volume_part1.mat'];
Recon_filename_part2 = [inputDir '../3_Final_reconstruction_volume/as_dep_GST_volume_part2.mat'];
...
ourputstring = [inputDir './Output/Atom_tracing_all_peaks_as_dep_GST'];
