...
addpath('./src/');
inputpath='./Output/';
saveprefix='Atom_tracing_non_atom_removed_anneal_30min_GST';

% load recontrcution volume
rec = importdata('../3_Final_reconstruction_volume/anneal_30min_GST_volume.mat');
rec=double(rec);

% load tracing results
TracingResult = importdata([inputpath 'Atom_tracing_all_peaks_anneal_30min_GST']);
