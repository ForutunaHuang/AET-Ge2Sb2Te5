...
addpath('./src/');
inputpath='./Output/';
saveprefix='Atom_tracing_non_atom_removed_as_dep_GST';

% load recontrcution volume
rec = importdata('../3_Final_reconstruction_volume/as_dep_GST_volume.mat');
rec=double(rec);

% load tracing results
TracingResult = importdata([inputpath 'Atom_tracing_all_peaks_as_dep_GST']);
