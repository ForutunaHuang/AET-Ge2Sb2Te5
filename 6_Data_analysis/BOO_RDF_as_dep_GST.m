...
model = importdata('./Input/Final_atomic_model_as_dep_GST.mat');
atoms = importdata('./Input/Final_atomtype_as_dep_GST.mat');
...
save('./OutPut/RDF_as_dep_GST.mat','radius_arr','rdf_arr','pdf_arr')
